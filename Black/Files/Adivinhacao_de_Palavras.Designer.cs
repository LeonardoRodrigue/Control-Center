...
{
	partial class Adivinhacao_de_Palavras
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.labeltentativasrest.TabIndex = 37;
			...
			this.labelResultado.Location = new System.Drawing.Point(0, 250);
			...
			// bntnivel3
			// 
			this.bntnivel3.BackColor = System.Drawing.Color.Black;
			...
			this.bntnivel3.TabIndex = 34;
			this.bntnivel3.Text = "Marca";
			this.bntnivel3.UseVisualStyleBackColor = false;
			this.bntnivel3.Click += new System.EventHandler(this.Bntnivel3Click);
			// 
			// bntnivel2
			// 
			this.bntnivel2.BackColor = System.Drawing.Color.Black;
			...
			this.bntnivel2.TabIndex = 33;
			this.bntnivel2.Text = "Fruta";
			this.bntnivel2.UseVisualStyleBackColor = false;
			this.bntnivel2.Click += new System.EventHandler(this.Bntnivel2Click);
			// 
			// bntnuivel1
			// 
			this.bntnuivel1.BackColor = System.Drawing.Color.Black;
			...
			this.bntnuivel1.TabIndex = 32;
			this.bntnuivel1.Text = "Programação";
			this.bntnuivel1.UseVisualStyleBackColor = false;
			...
			this.Anter.TabIndex = 30;
			this.Anter.Text = "ᐸ";
			this.Anter.Click += new System.EventHandler(this.AnterClick);
			// 
			// buttonTentar
			// 
			this.buttonTentar.BackColor = System.Drawing.Color.Black;
			this.buttonTentar.Enabled = false;
			...
			this.buttonTentar.TabIndex = 28;
			this.buttonTentar.Text = "Tentar";
			this.buttonTentar.UseVisualStyleBackColor = false;
			...
			this.label1.Text = "Jogo de Adivinhação de Palavras";
			this.label1.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// bntnew
			// 
			this.bntnew.BackColor = System.Drawing.Color.Black;
			this.bntnew.ForeColor = System.Drawing.SystemColors.ControlLightLight;
			this.bntnew.Location = new System.Drawing.Point(12, 496);
			this.bntnew.Name = "bntnew";
			this.bntnew.Size = new System.Drawing.Size(78, 30);
			this.bntnew.TabIndex = 38;
			...
			this.msktentativas.Location = new System.Drawing.Point(310, 313);
			this.msktentativas.Name = "msktentativas";
			this.msktentativas.Size = new System.Drawing.Size(220, 26);
			this.msktentativas.TabIndex = 39;
			this.msktentativas.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// Adivinhacao_de_Palavras
			// 
			...
			this.Name = "Adivinhacao_de_Palavras";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Adivinhacao_de_Palavras";
