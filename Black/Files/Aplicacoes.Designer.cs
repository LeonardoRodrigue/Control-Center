...
namespace Central_de_Controle
{
	partial class Aplicacoes
	{
		...
		private void InitializeComponent()
		{
			...
			this.iMCToolStripMenuItem.Size = new System.Drawing.Size(137, 22);
			...
			this.iPVAToolStripMenuItem.Size = new System.Drawing.Size(137, 22);
			...
			// bntCalculadora
			// 
			this.bntCalculadora.BackColor = System.Drawing.Color.Black;
			...
			this.bntCalculadora.UseVisualStyleBackColor = false;
			this.bntCalculadora.Click += new System.EventHandler(this.Button1Click);
			// 
			// bntIMC
			// 
			this.bntIMC.BackColor = System.Drawing.Color.Black;
			...
			// bntIPVA
			// 
			this.bntIPVA.BackColor = System.Drawing.Color.Black;
			...
			this.bntIPVA.UseVisualStyleBackColor = false;
			...
			// bntAdivin
			// 
			this.bntAdivin.BackColor = System.Drawing.Color.Black;
			...
			this.bntAdivin.UseVisualStyleBackColor = false;
			...
			this.label7.Location = new System.Drawing.Point(622, 330);
			this.label7.Name = "label7";
			this.label7.Size = new System.Drawing.Size(147, 29);
			this.label7.TabIndex = 13;
			this.label7.Text = "Gestão Financeira";
			// 
			// label8
			// 
